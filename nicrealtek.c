...
void nicrealtek_chip_writeb(const struct flashctx *flash, uint8_t val, chipaddr addr)
{
...
uint8_t nicrealtek_chip_readb(const struct flashctx *flash, const chipaddr addr)
{
	uint8_t val;
